CREATE DATABASE  IF NOT EXISTS `tasty_eatery` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `tasty_eatery`;
-- MySQL dump 10.13  Distrib 8.0.31, for Win64 (x86_64)
--
-- Host: localhost    Database: tasty_eatery
-- ------------------------------------------------------
...
INSERT INTO `food_items` VALUES (1,'Sandwich',6.00),(2,'Chicken Tenders',7.00),(3,'Pizza',8.00),(4,'Apple Pie',5.00),(5,'Whopper',6.00),(6,'Cheeseburger',9.00),(7,'Burrito',4.00),(8,'Egg McMuffin',7.00),(9,'French Fries',5.00);
...
--
-- Dumping routines for database 'tasty_eatery'
--
